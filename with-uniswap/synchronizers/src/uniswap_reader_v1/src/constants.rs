...
pub const URL: &str = "https://eth-mainnet.g.alchemy.com/v2/JVUDgQSB0r-3HhohPCod6uBy_Zx8WEdy";
pub const DEFAULT_POOL_ADDR: &str = "88e6A0c2dDD26FEEb64F039a2c41296FcB3f5640"; // USDC/WETH/500

pub const DEFAULT_FETCH_INTERVAL_BY_SEC: u64 = 10;
pub const INDEXED_TIME_UNIT_BY_SEC: u32 = 3 * 60;
