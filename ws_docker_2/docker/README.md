...
docker run -t --name dfx_hardhat_node -p 18545:18545 -p 14943:14943 --rm dfx_hardhat_node
### docker run -it --name dfx_hardhat_node --rm dfx_hardhat_node /bin/bash
...
docker container stop dfx_hardhat_node
