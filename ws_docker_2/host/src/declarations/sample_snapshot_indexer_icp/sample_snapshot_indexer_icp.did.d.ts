...
export interface CustomResponseStruct { 'value' : string, 'timestamp' : bigint }
export type Env = { 'Production' : null } |
  { 'Test' : null } |
  { 'LocalDevelopment' : null };
export interface ICSnapshotIndexerSourceAttrs { 'function_name' : string }
...
export interface _SERVICE {
  ...
  'get_last_snapshot_value' : ActorMethod<[], CustomResponseStruct>,
  'get_proxy' : ActorMethod<[], Principal>,
  'get_snapshot' : ActorMethod<[bigint], Snapshot>,
  'get_snapshot_value' : ActorMethod<[bigint], CustomResponseStruct>,
  'get_snapshots' : ActorMethod<[], Array<Snapshot>>,
  'get_sources' : ActorMethod<[], Array<Sources>>,
  'get_top_snapshot_values' : ActorMethod<
    [bigint],
    Array<CustomResponseStruct>
  >,
  ...
  'setup' : ActorMethod<[string], Result_1>,
